import { Button, Card, Colors, Tag, H6 } from "@blueprintjs/core";
...
const PokerTable: React.FC<PokerTableProps> = ({ style, gameStore }) => {
  ...
  return (
    <div className={css(styles.root, style)}>
      <div className={css(styles.tableSurface)} />
      <div className={css(styles.seats)}>
        {AllSeats.map((seat) => {
    ...
    () =>
      StyleSheet.create({
        ...
        seats: {
          ...
          gridTemplateRows: "4fr 4fr 1fr 4fr 4fr",
          gap: 32,
